...
public class ContactUsController {
	...
	@RequestMapping(value = { "/public/contact-us" }, method = RequestMethod.GET)
	public String indexPage(@CurrentUser User currentUser, Model model) {
		...
		model.addAttribute("administrators", positionAndPositionHoldersService
				.findAllCurrentPositionAndPositionHoldersForPosition(positionService.findById(4l)));
