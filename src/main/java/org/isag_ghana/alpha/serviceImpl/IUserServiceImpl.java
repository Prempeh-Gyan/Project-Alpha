...
import org.isag_ghana.alpha.repository.VerificationTokenRepository;
...
public class IUserServiceImpl implements IUserService {
	...
	public static String APP_NAME = "ISAG-Ghana Web App";

	// API
	/*
	 * @Override public User registerNewUserAccount(final SignUpFormDTO
	 * accountDto) { if (emailExist(accountDto.getEmail())) { throw new
	 * UserAlreadyExistException("There is an account with that email adress: "
	 * + accountDto.getEmail()); }
	 * 
	 * final User user = accountDto.createUser(new User());
	 * 
